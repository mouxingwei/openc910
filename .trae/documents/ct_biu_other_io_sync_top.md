...
| pad_biu_csr_rdata | input | 128 | |
| pad_biu_dbgrq_b | input | 1 | |
| pad_biu_hpcp_l2of_int | input | 4 | |
| pad_biu_me_int | input | 1 | |
| pad_biu_ms_int | input | 1 | |
| pad_biu_mt_int | input | 1 | |
| pad_biu_se_int | input | 1 | |
| pad_biu_ss_int | input | 1 | |
| pad_biu_st_int | input | 1 | |
| pad_core_hartid | input | 3 | |
| pad_core_rvba | input | 40 | |
...
| biu_pad_cnt_en | output | 4 | |
| biu_pad_csr_sel | output | 1 | |
| biu_pad_csr_wdata | output | 80 | |
| biu_pad_jdb_pm | output | 1 | |
| biu_pad_lpmd_b | output | 1 | |
| biu_xx_dbg_wakeup | output | 1 | |
| biu_xx_int_wakeup | output | 1 | |
| biu_xx_normal_work | output | 1 | |
| biu_xx_pmp_sel | output | 1 | |
