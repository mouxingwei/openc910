...
取指单元 (Instruction Fetch Unit)，主要信号: 使能信号、读使能、输入信号、数据信号、有效信号
...
| cp0_idu_frm | input | 3 |  |
| cp0_idu_fs | input | 2 |  |
| cp0_ifu_bht_en | input | 1 | 使能信号 |
| cp0_ifu_bht_inv | input | 1 | 输入信号 |
| cp0_ifu_btb_en | input | 1 | 使能信号 |
| cp0_ifu_btb_inv | input | 1 | 输入信号 |
| cp0_ifu_icache_en | input | 1 | 使能信号 |
| cp0_ifu_icache_inv | input | 1 | 输入信号 |
| cp0_ifu_icache_pref_en | input | 1 | 使能信号 |
| cp0_ifu_icache_read_index | input | 17 | 读使能 |
| cp0_ifu_icache_read_req | input | 1 | 请求信号 |
| cp0_ifu_icache_read_tag | input | 1 | 读使能 |
| cp0_ifu_icache_read_way | input | 1 | 读使能 |
| cp0_ifu_icg_en | input | 1 | 使能信号 |
| cp0_ifu_ind_btb_en | input | 1 | 使能信号 |
| cp0_ifu_ind_btb_inv | input | 1 | 输入信号 |
| cp0_ifu_insde | input | 1 | 输入信号 |
| cp0_ifu_iwpe | input | 1 |  |
| cp0_ifu_l0btb_en | input | 1 | 使能信号 |
| cp0_ifu_lbuf_en | input | 1 | 使能信号 |
| cp0_ifu_no_op_req | input | 1 | 请求信号 |
| cp0_ifu_nsfe | input | 1 |  |
| cp0_ifu_ras_en | input | 1 | 使能信号 |
| ... | ... | ... | 共133个输入端口 |
...
| 信号名 | 方向 | 位宽 | 描述 |
|--------|------|------|------|
| ifu_biu_r_ready | output | 1 | 就绪信号 |
| ifu_biu_rd_addr | output | 40 | 地址信号 |
| ifu_biu_rd_burst | output | 2 | 复位信号 |
| ifu_biu_rd_cache | output | 4 |  |
| ifu_biu_rd_domain | output | 2 | 输入信号 |
| ifu_biu_rd_id | output | 1 |  |
| ifu_biu_rd_len | output | 2 | 使能信号 |
| ifu_biu_rd_prot | output | 3 |  |
| ifu_biu_rd_req | output | 1 | 请求信号 |
| ifu_biu_rd_req_gate | output | 1 | 请求信号 |
| ifu_biu_rd_size | output | 3 |  |
| ifu_biu_rd_snoop | output | 4 | 操作码 |
| ifu_biu_rd_user | output | 2 |  |
| ifu_cp0_bht_inv_done | output | 1 | 输入信号 |
| ifu_cp0_btb_inv_done | output | 1 | 输入信号 |
| ifu_cp0_icache_inv_done | output | 1 | 输入信号 |
| ifu_cp0_icache_read_data | output | 128 | 数据信号 |
| ifu_cp0_icache_read_data_vld | output | 1 | 有效信号 |
| ifu_cp0_ind_btb_inv_done | output | 1 | 输入信号 |
| ifu_cp0_rst_inv_req | output | 1 | 复位信号 |
| ifu_had_debug_info | output | 83 | 输入信号 |
| ifu_had_no_inst | output | 1 | 指令信号 |
| ifu_had_no_op | output | 1 | 操作码 |
| ifu_had_reset_on | output | 1 | 复位信号 |
| ifu_hpcp_btb_inst | output | 1 | 程序计数器 |
| ifu_hpcp_btb_mispred | output | 1 | 读使能 |
| ifu_hpcp_frontend_stall | output | 1 | 使能信号 |
| ifu_hpcp_icache_access | output | 1 | 程序计数器 |
| ifu_hpcp_icache_miss | output | 1 | 程序计数器 |
| ifu_idu_ib_inst0_data | output | 73 | 数据信号 |
| ... | ... | ... | 共64个输出端口 |
...
| 层级 | 模块名 | 实例名 | 功能描述 |
|------|--------|--------|----------|
| 1 | ct_ifu_addrgen | x_ct_ifu_addrgen | 取指单元 |
| 1 | ct_ifu_bht | x_ct_ifu_bht | 取指单元 |
| 1 | ct_ifu_btb | x_ct_ifu_btb | 取指单元 |
| 1 | ct_ifu_l0_btb | x_ct_ifu_l0_btb | 取指单元 |
| 1 | ct_ifu_sfp | x_ct_ifu_sfp | 取指单元 |
| 1 | ct_ifu_ibctrl | x_ct_ifu_ibctrl | 取指单元 |
| 1 | ct_ifu_ibdp | x_ct_ifu_ibdp | 取指单元 |
| 1 | ct_ifu_ibuf | x_ct_ifu_ibuf | 取指单元 |
| 1 | ct_ifu_icache_if | x_ct_ifu_icache_if | 取指单元 |
| 1 | ct_ifu_ifctrl | x_ct_ifu_ifctrl | 取指单元 |
| 1 | ct_ifu_ifdp | x_ct_ifu_ifdp | 取指单元 |
| 1 | ct_ifu_ind_btb | x_ct_ifu_ind_btb | 取指单元 |
| 1 | ct_ifu_ipb | x_ct_ifu_ipb | 取指单元 |
| 1 | ct_ifu_ipctrl | x_ct_ifu_ipctrl | 取指单元 |
| 1 | ct_ifu_ipdp | x_ct_ifu_ipdp | 取指单元 |
| 1 | ct_ifu_l1_refill | x_ct_ifu_l1_refill | 取指单元 |
| 1 | ct_ifu_lbuf | x_ct_ifu_lbuf | 取指单元 |
| 1 | ct_ifu_pcfifo_if | x_ct_ifu_pcfifo_if | 取指单元 |
| 1 | ct_ifu_pcgen | x_ct_ifu_pcgen | 取指单元 |
| 1 | ct_ifu_ras | x_ct_ifu_ras | 取指单元 |
| ... | ... | ... | 共22个实例 |
