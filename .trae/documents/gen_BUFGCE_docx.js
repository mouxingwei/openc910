...
const doc = new Document({
    ...
    sections: [{
        ...
        children: [
            new Paragraph({ heading: HeadingLevel.HEADING_1, children: [new TextRun("BUFGCE 模块设计文档")] }),
            ...
            new Table({
                ...
                rows: [
                    ...
                    new TableRow({ children: [
                        ...
                        new TableCell({ borders, children: [new Paragraph({ children: [new TextRun("BUFGCE")] })] })
                    ]}),
                    new TableRow({ children: [
                        new TableCell({ borders, children: [new Paragraph({ children: [new TextRun("文件路径")] })] }),
                        new TableCell({ borders, children: [new Paragraph({ children: [new TextRun("common\rtl\BUFGCE.v")] })] })
                    ]}),
                    new TableRow({ children: [
            ...
            new Table({
                ...
                rows: [
                    ...
                    new TableRow({ children: [
                        new TableCell({ borders, width: { size: 4680, type: WidthType.DXA }, children: [new Paragraph({ children: [new TextRun("I")] })] }),
                    ...
                    new TableRow({ children: [
                        new TableCell({ borders, width: { size: 4680, type: WidthType.DXA }, children: [new Paragraph({ children: [new TextRun("CE")] })] }),
                        new TableCell({ borders, width: { size: 1560, type: WidthType.DXA }, children: [new Paragraph({ children: [new TextRun("input")] })] }),
                        new TableCell({ borders, width: { size: 1560, type: WidthType.DXA }, children: [new Paragraph({ children: [new TextRun("1")] })] }),
                        new TableCell({ borders, width: { size: 1560, type: WidthType.DXA }, children: [new Paragraph({ children: [new TextRun("")] })] })
                    ] }),
            ...
            new Table({
                ...
                rows: [
                    ...
                    new TableRow({ children: [
                        new TableCell({ borders, width: { size: 4680, type: WidthType.DXA }, children: [new Paragraph({ children: [new TextRun("O")] })] }),
