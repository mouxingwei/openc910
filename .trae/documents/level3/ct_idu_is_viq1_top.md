...
| ctrl_viq1_create0_en | input | 1 | |
| ctrl_viq1_create0_gateclk_en | input | 1 | |
| ctrl_viq1_create1_dp_en | input | 1 | |
| ctrl_viq1_create1_en | input | 1 | |
| ctrl_viq1_create1_gateclk_en | input | 1 | |
| ctrl_viq1_rf_lch_fail_vld | input | 1 | |
| ctrl_viq1_rf_pipe6_vmla_vreg_fwd_vld | input | 8 | |
| ctrl_viq1_rf_pipe7_vmla_vreg_fwd_vld | input | 8 | |
| ctrl_viq1_rf_pop_dlb_vld | input | 1 | |
| ctrl_viq1_rf_pop_vld | input | 1 | |
| ctrl_viq1_stall | input | 1 | |
| ctrl_xx_rf_pipe6_vmla_lch_vld_dupx | input | 1 | |
| ctrl_xx_rf_pipe7_vmla_lch_vld_dupx | input | 1 | |
| dp_viq1_bypass_data | input | 150 | |
| dp_viq1_create0_data | input | 150 | |
| dp_viq1_create1_data | input | 150 | |
| dp_viq1_create_srcv0_rdy_for_bypass | input | 1 | |
| ... | ... | ... | 共75个端口 |
...
| 信号名 | 方向 | 位宽 | 描述 |
|--------|------|------|------|
| viq1_ctrl_1_left_updt | output | 1 | |
| viq1_ctrl_empty | output | 1 | |
| viq1_ctrl_entry_cnt_updt_val | output | 4 | |
| viq1_ctrl_entry_cnt_updt_vld | output | 1 | |
| viq1_ctrl_full | output | 1 | |
| viq1_ctrl_full_updt | output | 1 | |
| viq1_ctrl_full_updt_clk_en | output | 1 | |
| viq1_dp_issue_entry | output | 8 | |
| viq1_dp_issue_read_data | output | 150 | |
| viq1_top_viq1_entry_cnt | output | 4 | |
| viq1_viq_create0_entry | output | 8 | |
| viq1_viq_create1_entry | output | 8 | |
| viq1_xx_gateclk_issue_en | output | 1 | |
| viq1_xx_issue_en | output | 1 | |
