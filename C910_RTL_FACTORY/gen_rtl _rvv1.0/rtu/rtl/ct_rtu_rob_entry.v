...
parameter ROB_CMPLT_CNT       = 4;
parameter ROB_CMPLT           = 2;
parameter ROB_VLD             = 1;
parameter ROB_RESERVED        = 0;
...
assign x_read_data[ROB_VLMUL:ROB_VLMUL-2]         = vlmul[2:0];
assign x_read_data[ROB_VMA]                       = vma;
assign x_read_data[ROB_VTA]                       = vta;
