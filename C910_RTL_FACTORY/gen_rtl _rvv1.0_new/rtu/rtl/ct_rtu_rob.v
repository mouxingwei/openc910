...
//----------------------------------------------------------
//                     ROB Parameters
// Modified for RVV 1.0: Extended vlmul to 3 bits, added vma/vta fields
// Modification date: 2026-04-01
//----------------------------------------------------------
parameter ROB_WIDTH           = 42;

parameter ROB_VL_PRED         = 41;
parameter ROB_VL              = 40;
parameter ROB_VEC_DIRTY       = 32; 
parameter ROB_VSETVLI         = 31; 
parameter ROB_VSEW            = 30; 
parameter ROB_VLMUL           = 27; 
parameter ROB_VMA             = 26;
parameter ROB_VTA             = 25;
parameter ROB_NO_SPEC_MISPRED = 24; 
parameter ROB_NO_SPEC_MISS    = 23; 
parameter ROB_NO_SPEC_HIT     = 22; 
parameter ROB_LOAD            = 21; 
parameter ROB_FP_DIRTY        = 20; 
parameter ROB_INST_NUM        = 19; 
parameter ROB_BKPTB_INST      = 17; 
parameter ROB_BKPTA_INST      = 16; 
parameter ROB_BKPTB_DATA      = 15; 
parameter ROB_BKPTA_DATA      = 14; 
parameter ROB_STORE           = 13; 
parameter ROB_RAS             = 12; 
parameter ROB_PCFIFO          = 11; 
parameter ROB_BJU             = 10;
parameter ROB_INTMASK         = 9;
parameter ROB_SPLIT           = 8;
parameter ROB_PC_OFFSET       = 7;
